...
import 'package:flutter_e_commerce_app/domain/controllers/screen_controller/default_intro_controller.dart';
...
class DefaultIntroScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final DefaultIntroController defaultIntroController =
        Get.put(DefaultIntroController());
    return Scaffold(
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            BounceInDown(
              duration:
                  Duration(milliseconds: defaultIntroController.startDuration),
              child: const Image(
            ...
            BounceInLeft(
              duration: Duration(
                  milliseconds: defaultIntroController.startDuration * 2),
              child: const Align(
            ...
            BounceInLeft(
              duration: Duration(
                  milliseconds: defaultIntroController.startDuration * 3),
            ...
            BounceInRight(
              duration: Duration(
                  milliseconds: defaultIntroController.startDuration * 4),
            ...
            BounceInLeft(
              ...
              child: CustomButton(
                ...
                onTap: defaultIntroController.companyTAP,
                child: const CustomText(
            ...
            BounceInRight(
              ...
              child: CustomButton(
                width: 175,
                onTap: defaultIntroController.customerTAP,
                child: const CustomText(
